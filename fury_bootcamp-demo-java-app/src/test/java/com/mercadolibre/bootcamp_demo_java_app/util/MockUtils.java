...
public class MockUtils {
	...
	public static void mockItemRequest(String itemId, int statusCode) throws URISyntaxException, IOException {
		...
		MockResponse.builder().withURL("http://fake.api.mercadolibre.com/items/"+itemId+"?attributes=id,title,price,site_id,currency_id,accepts_mercadopago").withMethod(HttpMethod.GET)
